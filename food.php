...
<video id="sliderVideo" autoplay loop muted>
  <source src="img\Dining\food.mp4" type="video/mp4">
...
<div class="image-content">
    <img src="img\Dining\round.png" alt="Catering Image">
  </div>
    <div class="text-section">
        ...
        <p>Under the richly decorated, glass-domed majesty of the Garden Court, you can treat yourself to a dining experience that’s as spectacular as its iconic setting.</p>
    ...
    <div class="image-section">
        <img src="img\Dining\first_food_1.jpg" alt="Cocktail" class="small-image">
        <br>
        <img src="img\Dining\first_food_2.jpg" alt="Oysters" class="small-image">
    </div>
...
<div class="second-container">
    <div class="info-section">
        ...
        <p class="description">“The Pied Piper” mural overlooking our elegant bar has captivated patrons from around the world for over a century. This iconic Maxfield Parrish masterpiece gives our historic bar its name and inspires our staff to treat every cocktail and plate like a work of art.</p>
        <p class="description">Explore the menu of shareable plates, cocktails, beer, wine, and spirits.</p>
        <p class="highlight">Everyday, 5:00 PM–11:30 PM</p>
        <div class="action-links">
            <a href="#">Visit website</a>
            <a href="#">Book a private event</a>
            <a href="#">Take a glimpse</a>
        </div>
    </div>
    <div class="image-display">
        <img src="img\Dining\second container.jpg" alt="Pied Piper Bar Scene">
    </div>
</div>
...
<div class="dining">
    ...
    <div class="dining-cards">
        ...
        <div class="dining-card">
            <img src="img\Dining\card1.jpg" alt="Whiskey Selection at Pied Piper">
            <div class="dining-card-content">
                ...
                <p class="description">Pied Piper’s esteemed spirits list includes acclaimed whiskeys from the U.S., Canada, Ireland, Japan, and Scotland.</p>
                <a href="#">View menu</a>
            </div>
        </div>
        ...
        <!-- Second Card -->
        <div class="dining-card">
            <img src="img\Dining\card2.jpg" alt="Epicurean Offerings">
            <div class="dining-card-content">
        ...
        <!-- Third Card -->
        <div class="dining-card">
            <img src="img\Dining\card3.jpg" alt="The Pied Piper Burger">
            <div class="dining-card-content">
...
<div class="third-container">
  <div class="image-section">
    <img src="img\Dining\fourth.jpg" alt="Pied Piper Mural">
  </div>
  <div class="text-section">
...
<div class="fourth-container">
  <div class="text-section">
    ...
    <div class="schedule">
      <p><strong>Mon–Fri,</strong> 6:30 AM–10:30 AM, 12:00 PM–2:00 PM<br>
      <strong>Sat,</strong> 6:30 AM–10:30 AM, 12:00 PM–2:00 PM, 2:00 PM–4:00 PM<br>
  ...
  <div class="image-section">
    <img src="img\Dining\fifth.jpg" alt="Garden Court Restaurant">
  </div>
</div>
...
<div class="second-Dining-cards">
  <div class="dining">
    ...
    <div class="second-Dining-cards">
      <!-- Card 1 -->
      <div class="card">
        <img src="img\Dining\card4.jpg" alt="Room Service">
        <h4>ROOM SERVICE</h4>
        ...
        <a href="#">Explore in-room dining</a>
      </div>

      <!-- Card 2 -->
      <div class="card">
        <img src="img\Dining\card5.jpg" alt="Green Goddess Dressing">
      ...
      <!-- Card 3 -->
      <div class="card">
        <img src="img\Dining\card6.jpg" alt="Concierge Service">
        <h4>CONCIERGE</h4>
        <h2>At Your Service</h2>
        <p>Our Concierge team goes above and beyond to ensure your stay is exceptional. They’re here to curate your experience and passionate about guiding you towards the best that San Francisco has to offer.</p>
...
<div class="six-container">
    <div class="six-image">
        <img src="img\Dining\round2.png" alt="Festive Season">
    </div>
...
<div class="last-container">
  ...
  <div class="card-container">
    <div class="card">
      ...
      <p>House of Shields is one of San Francisco’s oldest bars having originally opened in 1908, and continues to serve some of the city’s best handcrafted cocktails.</p>
  ...
  <div class="card-container">
    <div class="card">
      ...
      <p>Don’t miss this San Francisco institution that has been serving cocktails and classic dishes for the past 75 years.</p>
      <a href="#">View website</a>
    </div>
    <div class="card">
      <h3>Lao Table</h3>
