...
<head>
  ...
  <title>About Us - Dynasty Hotels</title>
...
<div class="slider-container">
    ...
    <button id="muteBtn" onclick="toggleMute()"><i class="fas fa-volume-up"></i></button>
        ...
        <!-- Slide 2: Image -->
        <div class="slide">
            <img src="img\about_us\facade high res.jpeg" alt="Image 1">
        </div>
        
        <!-- Slide 3: Image -->
        <div class="slide">
            <img src="img\index\Travel+Leisure-Awards_0.jpg.webp" alt="Image 2">
        </div>
        
        <!-- Slide 4: Image -->
        <div class="slide">
          
            <img src="img\about_us\outside.jpg" alt="Image 3">
        </div>
    </div>
    <!-- Navigation Buttons -->
...
<div class="decorative-divider">
      <h2># Our Story</h2>
          <img src="img\about_us\text-demo.svg " alt="decorative divider">
    </div>
  <!-- Our Story Section -->
  ...
  <!-- first image star  -->
 <div class="section">
             <img src="img\about_us\alsonot.webp" alt="Responsible Luxury">
        <div class="text-content">
            <h2 >RESPONSIBLE LUXURY</h2>
            <div class="divider">
                      <img class="icon" src="img\about_us\thired-icon.svg" alt="Responsible Luxury"> 
                 </div>
...
<!-- 2 image star  -->
    <div class="section">
              <img src="img\about_us\view.jpeg" alt="Design & Detailing">
          <div class="text-content">
...
<p> This serene hotel setting harmoniously blends natural beauty with refined architecture. Overlooking a scenic waterfront, the lush gardens feature manicured lawns, palm trees, and water features with floating lilies, creating an oasis of calm. Distinctive outdoor seating areas are thoughtfully designed for relaxation, surrounded by tranquil ponds and soft ambient lighting. The backdrop of historic architecture and the gentle hills adds to the immersive experience, seamlessly celebrating the rich cultural heritage of the destination. This space invites guests to unwind and connect with nature in an environment crafted for wellbeing and rejuvenation.</p>
        ...
        <!-- 2 image end  -->
         ...
         <!-- 3 image star  -->
 <div class="section">
             <img src="img\about_us\inside2.jpg" alt="Responsible Luxury">
        <div class="text-content">
...
<!-- 4 image star  -->
    <div class="section">
              <img src="img\about_us\homeSliderImage.png" alt="Design & Detailing">
          <div class="text-content">
      ...
      <div class="card-container">
                  <div class="card">
                      <img src="img\about_us\pexels-pixabay-261169.jpg" alt="Kaya Kalp - The Spa">
                  ...
                  <div class="card">
                      <img src="img\about_us\mass_spa.jpg" alt="Kaya Kalp - The Spa">
                  ...
                  <div class="card">
                      <img src="img\about_us\gift-card.png" alt="Health & Fitness Centre">
                  ...
                  <div class="card">
                      <img src="img\about_us\pexels-pixabay-262047.jpg" alt="Swimming Pool">
                      <div class="card-title">Gather Around Grandeur</div>
                      <div class="card-description">
                      Experience the charm of our spacious dining table, perfect for family feasts or elegant gatherings. Crafted for comfort and style, it’s the centerpiece for creating cherished memories.                      </div>
                  </div>
              </div>
           </div>
